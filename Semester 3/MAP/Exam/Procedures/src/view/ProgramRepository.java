...
public class ProgramRepository {
    ...
    private void initPrograms() {
        ...
        procTable.addProcedure("product",
                List.of("a", "b"),
                new CompStmt(
                        new VarDeclStmt("v", new IntType()),
                        new CompStmt(
        ...
        addControllerWithProcedures(ex13, "Example 13: Procedures (sum & product)", "log13.txt", procTable);
    ...
    private void addController(IStmt stmt, String name, String logFile) {
        try {
            ...
            PrgState prg = new PrgState(exeStack, symTable, out, fileTable, stmt, heap, procTable);
    ...
    private void addControllerWithProcedures(IStmt stmt, String name, String logFile, IProcTable procTable) {
        try {
            ISymbolTable<String, Type> typeEnv = new SymbolTable<>();
            stmt.typecheck(typeEnv);
