...
public class ProgramRepository {
    ...
    private void initPrograms() {
        ...
        IStmt switchExample = new CompStmt(
                new VarDeclStmt("a", new IntType()),
                new CompStmt(
                        new VarDeclStmt("b", new IntType()),
                        new CompStmt(
                                        ...
                                        new CompStmt(
                                                ...
                                                new CompStmt(
                                                        ...
                                                        new CompStmt(
                                                                ...
                                                                // print 300 after the switch to get final Out = {1,2,300}
                                                                new PrintStmt(new ValueExp(new IntValue(300)))
                                                        )
                                                )
                                        )
        ...
        addController(exSemaphore, "Example", "logSemaphore.txt");
        addController(switchExample, "Example switch", "logSwitch.txt");
    ...
    private void addController(IStmt stmt, String name, String logFile) {
        try {
            ...
            PrgState prg = new PrgState(exeStack, symTable, out, fileTable, stmt, heap, semaphoreTable);
