...
public class MainWindowController {
    ...
    public void initialize() {
        ...
        semaphoreListColumn.setCellValueFactory(data ->
                new SimpleStringProperty(
                        data.getValue().getValue().getValue().toString()
                ));
    ...
    private void updateUI() {
        ...
        var semaphoreContent = firstPrg.semaphoreTable().getContent();
        semaphoreTableView.getItems().setAll(semaphoreContent.entrySet());
