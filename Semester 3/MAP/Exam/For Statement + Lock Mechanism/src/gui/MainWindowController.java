...
public class MainWindowController {
    ...
    @FXML
    private TableColumn<Map.Entry<Integer, Integer>, Integer> lockLocationColumn;
    ...
    public void initialize() {
        ...
        lockLocationColumn.setCellValueFactory(data ->
                new SimpleIntegerProperty(data.getValue().getKey()).asObject());
        lockValueColumn.setCellValueFactory(data ->
    ...
    private void updatePrgStateSpecificUI() {
        ...
        if (selectedPrg != null) {
            Map<Integer, Integer> lockContent = selectedPrg.lockTable().getContent();
            lockTableView.getItems().setAll(lockContent.entrySet());
        } else {
