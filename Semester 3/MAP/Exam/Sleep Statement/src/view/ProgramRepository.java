...
public class ProgramRepository {
    ...
    private void initPrograms() {
        ...
        IStmt Sleepex = new CompStmt(new VarDeclStmt("v", new IntType()), new CompStmt(new AssignStmt("v", new ValueExp(new IntValue(0))), new CompStmt(new WhileStmt(new RelExp(new VarExp("v"), new ValueExp(new IntValue(3)), "<"), new CompStmt(new ForkStmt(new CompStmt(new PrintStmt(new VarExp("v")), new AssignStmt("v", new ArithExp(new VarExp("v"), new ValueExp(new IntValue(1)), "+")))), new AssignStmt("v", new ArithExp(new VarExp("v"), new ValueExp(new IntValue(1)), "+")))), new CompStmt(new SleepStmt(5), new PrintStmt(new ArithExp(new VarExp("v"), new ValueExp(new IntValue(10)), "*"))))));
        ...
        addController(Sleepex, "Example 10: Nested Fork Example", "log10.txt");
