...
public class MainWindowController {
    ...
    public void initialize() {
        latchLocationColumn.setCellValueFactory(data ->
                new SimpleIntegerProperty(data.getValue().getKey()).asObject());

        latchValueColumn.setCellValueFactory(data ->
    ...
    private void updateUI() {
        ...
        Map<Integer, Integer> latchContent =
                firstPrg.latchTable().getContent();

        latchTableView.getItems().setAll(latchContent.entrySet());
