...
public class MainWindowController {
    ...
    public void initialize() {
        ...
        barrierIndexColumn.setCellValueFactory(data ->
                new SimpleIntegerProperty(data.getValue().getKey()).asObject());

        barrierValueColumn.setCellValueFactory(data ->
                new SimpleIntegerProperty(data.getValue().getValue().getKey()).asObject());

        barrierListColumn.setCellValueFactory(data -> {
            List<Integer> list = data.getValue().getValue().getValue();
    ...
    private void updatePrgStateSpecificUI() {
        ...
        if (selectedPrg != null) {
            ...
            Map<Integer, Pair<Integer, List<Integer>>> barrierContent = selectedPrg.barrierTable().getContent();
            barrierTableView.getItems().setAll(barrierContent.entrySet());
        } else {
            symTableView.getItems().clear();
            exeStackList.clear();
            exeStackListView.setItems(exeStackList);
