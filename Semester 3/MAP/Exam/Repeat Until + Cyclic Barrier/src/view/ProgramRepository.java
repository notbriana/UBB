...
public class ProgramRepository {
    ...
    private void initPrograms() {
        ...
        addController(ex11, "Example barrier table", "logBarrier.txt");
        addController(program, "Example repeat", "logRepeat.txt");
    ...
    private void addController(IStmt stmt, String name, String logFile) {
        try {
            ...
            PrgState prg = new PrgState(exeStack, symTable, out, fileTable, stmt, heap, barrierTable);
