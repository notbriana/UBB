...
void testDifference() {
	...
	int removedCount = set1.difference(set2);

	assert(removedCount == 2);

	assert(set1.search(1) == true);
	assert(set1.search(2) == true);
	assert(set1.search(3) == false);
	assert(set1.search(4) == false);


	assert(set2.search(3) == true);
	assert(set2.search(4) == true);
	assert(set2.search(5) == true);
	assert(set2.search(6) == true);

	Set set3;

	int removedCount1 = set1.difference(set3);
